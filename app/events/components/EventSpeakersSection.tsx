...
function SpeakerCard({ name, role, badge, image, index }: SpeakerCardProps) {
  return (
    <div
...
export default function EventSpeakersSection() {
  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-black">
